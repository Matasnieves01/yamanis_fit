...
class _CreatePromotionPageState extends State<CreatePromotionPage> {
  ...
  Future<void> _savePromotion() async {
    ...
    if (title.isEmpty || description.isEmpty || imageUrl.isEmpty || _videoIds.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Completa todos los campos y agrega al menos un video.')),
      );
      return;
    }
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isSaving
                    ...
                    : const Text('GUARDAR PROMOCIÓN', style: TextStyle(fontWeight: FontWeight.bold)),
              ),
            ),
          ],
        ),
